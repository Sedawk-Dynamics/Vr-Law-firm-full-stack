...
export function BlogContent({ html, onHeadings }: { html: string; onHeadings?: (h: { id: string; text: string; level: number }[]) => void }) {
  ...
  return (
    <div
      className="
        text-ivory/80 max-w-none
        [&_h2]:text-ivory [&_h2]:font-serif [&_h2]:text-3xl [&_h2]:lg:text-4xl [&_h2]:font-light [&_h2]:mt-12 [&_h2]:mb-5 [&_h2]:leading-tight [&_h2]:scroll-mt-28
        [&_h3]:text-ivory [&_h3]:font-serif [&_h3]:text-2xl [&_h3]:font-light [&_h3]:mt-10 [&_h3]:mb-4 [&_h3]:leading-tight [&_h3]:scroll-mt-28
        [&_p]:text-base [&_p]:leading-relaxed [&_p]:mb-5 [&_p]:text-ivory/75
        ...
        [&_em]:italic
        [&_ul]:my-6 [&_ul]:space-y-2 [&_ul]:pl-5 [&_ul]:list-disc [&_ul]:marker:text-gold/60
        [&_ol]:my-6 [&_ol]:space-y-2 [&_ol]:pl-5 [&_ol]:list-decimal [&_ol]:marker:text-gold/60
        [&_li]:text-ivory/75 [&_li]:leading-relaxed
        [&_blockquote]:border-l-2 [&_blockquote]:border-gold [&_blockquote]:pl-6 [&_blockquote]:py-2 [&_blockquote]:my-8 [&_blockquote]:text-xl [&_blockquote]:lg:text-2xl [&_blockquote]:text-ivory/85 [&_blockquote]:italic [&_blockquote]:font-light
